...
namespace MiddlewareBB {
    class Global {
        ...
        static std::queue < std::string > ts_list; //ts list to ask
        static std::vector < file > cache_ts; //cache with ts files
        ...
        static std::mutex lock_ts_list; //operation on ts_list
        static std::mutex lock_cache_ts; //operation on cache_ts
